...
const randomDrinks = () => {
    let promArr = []
    let randDrink =  fetch('https://www.thecocktaildb.com/api/json/v1/1/filter.php?c=Other/Unknown').then(resp => resp.json())
        ...
        `<div class="card" id="${idDrink}" title="card" href="#">
            <div class="card__background" style="background-image: url(${strDrinkThumb})" id="${idDrink}" title="card"></div>
                <div class="card__content" id="${idDrink}" title="card">
                    <p class="card__category" id="${idDrink}" title="card">Other</p>
